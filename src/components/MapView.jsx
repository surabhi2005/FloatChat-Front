...
// Some floating points (latitude, longitude)
const points = [
  { id: 1, name: "Point A", position: [13.0827, 80.2707] }, // Chennai
  { id: 2, name: "Point B", position: [12.9716, 77.5946] }, // Bangalore
  { id: 3, name: "Point C", position: [17.3850, 78.4867] }, // Hyderabad
];

const MapView = () => {
  return (
    <MapContainer
      center={[13.0827, 80.2707]} // initial center
      zoom={6}
